...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://retailiq.onrender.com/api/auth/login", {
        method: "POST",
        headers: {
...
function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await fetch("https://retailiq.onrender.com/api/auth/register", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
function Dashboard() {
  ...
  React.useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch("https://retailiq.onrender.com/api/products", {
          headers: {
...
function Products() {
  ...
  const handleAddProduct = async (e) => {
    ...
    const url = editingId
      ? `https://retailiq.onrender.com/api/products/${editingId}`
      : "https://retailiq.onrender.com/api/products";
  ...
  const handleDelete = async (id) => {
    try {
      const response = await fetch(`https://retailiq.onrender.com/api/products/${id}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
function LowStock() {
  ...
  React.useEffect(() => {
    const fetchProducts = async () => {
      const res = await fetch("https://retailiq.onrender.com/api/products", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
    ...
    const fetchInvoices = async () => {
      try {
        const response = await fetch(
          "https://retailiq.onrender.com/api/invoices"
        );
...
paymentDate: new Date().toLocaleDateString(),
  ...
  fetch("https://retailiq.onrender.com/api/invoices", {
  method: "POST",
  headers: {
    "Content-Type": "application/json",
  },
...
const deleteInvoice = async (id) => {
  ...
  try {
    const response = await fetch(
      `https://retailiq.onrender.com/api/invoices/${id}`,
      {
        method: "DELETE",
      }
    );
...
const saveInvoiceChanges = async () => {
  try {
    const response = await fetch(
      `https://retailiq.onrender.com/api/invoices/${selectedInvoice._id}`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
...
function PurchaseInvoices() {
  ...
  const fetchPurchaseInvoices = async () => {
    try {
      const response = await fetch(
        "https://retailiq.onrender.com/api/purchase-invoices",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  try {
    const response = await fetch(
      `https://retailiq.onrender.com/api/purchase-invoices/${id}`,
      {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
...
function ProfitLoss() {
  ...
  const fetchSalesInvoices = async () => {
    try {
      const response = await fetch("https://retailiq.onrender.com/api/invoices");
      const data = await response.json();
